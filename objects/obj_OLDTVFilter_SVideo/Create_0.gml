...
global.composite_distortion = 0.2;          //  0.0 ~ 1.0
global.composite_artifact = 0.015;          //  0.0 ~ 1.0
global.composite_fringing = 0.15;           //  0.0 ~ 1.0
global.composite_bleeding = 0.2;            //  0.0 ~ 1.0
...
global.chromatic_magnetude = 0.07;          // -1.0 ~ 1.0

//  Scanline Settings
global.scanline_enabled = true;
global.scanline_count = 140;
global.scanline_pattern = sprite_get_texture(sprScanline1,0);        
global.scanline_magnetude = 0.20          //  0.0 ~ 1.0
