...
if(meeting == 1 and mouse_check_button_pressed(mb_left) and o_settings_button.settings_on == false and o_loadout_button.loadout_on == false and o_stats_button.stats_on == false) 
{
