...
if(meeting == 1 and mouse_check_button_pressed(mb_left) and o_settings_button.settings_on == false and o_credits_button.credits_on == false and o_stats_button.stats_on == false) 
{
	sprite_index = s_loadout_button_pressed
	alarm[0] = 5
} else {
	sprite_index = s_loadout_button	
}
