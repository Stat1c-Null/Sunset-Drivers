if(place_meeting(x,y,obj_car) and global.gasAmount <= min_amount)//Check if car touched canister
{
	image_index = 0
...
}else if(place_meeting(x,y,obj_car) and global.gasAmount > min_amount)
{
