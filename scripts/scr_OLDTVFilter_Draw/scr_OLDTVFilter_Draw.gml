function scr_OLDTVFilter_Draw() {
	...
	draw_sprite_ext(s_speed_arrow, 1, 1710, 500, image_xscale, image_yscale, obj_car.arrow_rot, image_blend, image_alpha)
	...
	draw_text(obj_car.score_x_pos, 180, string(round(obj_car.player_score)))
